function instructions() {
    ...
    drawMirror(midx - 580 * (width / 1220),
               midy - 150 * (width / 1220),
               midx - 550 * (width / 1220),
               midy - 100 * (width / 1220), 0, 1);
    drawMirror(midx + 580 * (width / 1220),
               midy - 150 * (width / 1220),
               midx + 550 * (width / 1220),
               midy - 100 * (width / 1220), 0, 0);
    ...
    gameArena.fillStyle = "#E6FFFF";
    gameArena.fillText(str1, midx - 460 * (width / 1220),
                       midy - 130 * (width / 1220));
    gameArena.fillText(str2, midx + 480 * (width / 1220),
                       midy - 130 * (width / 1220));
    gameArena.shadowBlur = 50 * Math.abs(Math.sin(runtime1 / 20));
    gameArena.shadowColor = "#780000";
    gameArena.drawImage(enemyShip,
                        midx - 600 * (width / 1220),
                        midy - 50 * (width / 1220),
                        120 * (width / 1220),
                        114.43 * (width / 1220));
    ...
    gameArena.drawImage(spaceStation,
                        midx + 430 * (width / 1220),
                        midy - 55 * (width / 1220));
    var str3 = "Enemy Ship";
    var str31 = " Kill It! ";
    ...
    gameArena.fillText(str3,
                       midx - 420 * (width / 1220),
                       midy);
    gameArena.fillText(str31,
                       midx - 425 * (width / 1220),
                       midy + 30 * (width / 1220));
    gameArena.fillText(str4,
                       midx + 350 * (width / 1220),
                       midy + 40 * (width / 1220));
    gameArena.fillText(str41,
                       midx + 350 * (width / 1220),
                       midy + 70 * (width / 1220));
    ...
    gameArena.arc(midx - (250 * (width / 1220)),
                  midy + (70 * (width / 1220)),
                  2, 0, 2 * Math.PI);
    gameArena.fill();
    gameArena.beginPath();
    gameArena.fillStyle = "#21E821";
    gameArena.arc(midx - (150 * (width / 1220)),
                  midy + (70 * (width / 1220)),
                  2, 0, 2 * Math.PI);
    gameArena.fill();
    var str8 = "Asteroid";
    ...
    gameArena.font = "25px DJB";
    gameArena.fillStyle = "#E6FFFF";
    gameArena.fillText(str8,
                       midx + 90 * (width / 1220),
                       midy + 160 * (width / 1220));
    gameArena.fillText(str9,
                       midx - 200 * (width / 1220),
                       midy + 130 * (width / 1220));
    drawRay(width - 150 * (width / 1220),
    ...
    gameArena.shadowBlur = 10;
    gameArena.shadowColor = "#18CAE6";
    gameArena.drawImage(mainShip,
                        width - 152 * (width / 1220),
                        height - 94 * (width / 1220),
                        150 * (width / 1220),
                        89 * (width / 1220));
